...
### Available MCP tools
- **mcp_rustbrain_search_code** — semantic search over code_embeddings and doc_embeddings collections
...
- **mcp_rustbrain_context_store** — artifact CRUD (get, put, list_by_task, list_by_type) *(to be built — Phase 0)*
...
```
*Note: artifacts table will be created as part of Phase 0 infrastructure.*
